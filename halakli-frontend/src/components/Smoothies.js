...
const SMOOTHIES_SLUG =
  process.env.REACT_APP_CAT_SMOOTHING_SLUG || "home-smoothing";
  ...
  try {
    ...
    if (editModal.isNew) {
      ...
      const cat = (categories || []).find(
        (c) =>
          c.slug === SMOOTHIES_SLUG ||
          c.category_slug === SMOOTHIES_SLUG
      );

      const createPayload = {
        ...payload,
        ...(cat?.id ? { category_id: cat.id } : {}),
        ...(cat?.id ? {} : { category_slug: SMOOTHIES_SLUG }),
      };
        ...
        <section className="acct-section">
          ...
          >
            <ol>
              ...
              <li aria-current="page">החלקות ביתיות</li>
            </ol>
          </nav>

          <h1 className="acct-h1">החלקות ביתיות</h1>
          <h2>קנו עכשיו את ההחלקות הביתיות שלנו</h2>
        ...
        console.log(
          ...
          p.stock_qty
              ...
              const mainSrc = normalizeImageUrl(
                    p.image_url ||
                      `https://picsum.photos/seed/sm${p.id}/600/600`
                  );
